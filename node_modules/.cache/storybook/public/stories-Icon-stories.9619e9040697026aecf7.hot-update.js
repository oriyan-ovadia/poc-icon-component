...
function toArray(fuzzyResults) {
  return fuzzyResults.filter(function (result) {
    return (result === null || result === void 0 ? void 0 : result.score) != null ? result.score < 0.4 : false;
  }).map(function (result) {
    return result.item;
  });
}
var AllIcons = {
  render: function render(args) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      var filteredIcons = _Icon_types__WEBPACK_IMPORTED_MODULE_7__.iconsArr.filter(function (iconName) {
