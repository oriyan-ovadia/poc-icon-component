...
var _Primary$parameters, _Primary$parameters2, _Primary$parameters2$, _ThemeColor$parameter, _ThemeColor$parameter2, _ThemeColor$parameter3, _AllIcons$parameters, _AllIcons$parameters2, _AllIcons$parameters3;
...
var ThemeColor = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'When there\'s a need to take a heading tag and apply different styling to it, then the `variant` becomes handy. For example, the following heading is using a `<h1>` tag, but it behaves like a `<h3>` by using `variant="h3"`.'
      }
    }
  }
};
...
var __namedExportsOrder = ["Primary", "ThemeColor", "AllIcons"];
