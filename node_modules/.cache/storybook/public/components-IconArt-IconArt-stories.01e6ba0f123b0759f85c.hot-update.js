...
var AllIcons = {
  render: function render(args) {
    var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(_IconArt_types__WEBPACK_IMPORTED_MODULE_10__.iconArtArr),
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      if (!debouncedSearchQuery.trim()) {
        return setIcons(_IconArt_types__WEBPACK_IMPORTED_MODULE_10__.iconArtArr);
      }
      var searchResults = [];
      if (isFuzzySearch) {
        searchResults = toIconsArray(fuzzySearch.search(debouncedSearchQuery));
      } else {
        searchResults = _IconArt_types__WEBPACK_IMPORTED_MODULE_10__.iconArtArr.filter(function (iconName) {
