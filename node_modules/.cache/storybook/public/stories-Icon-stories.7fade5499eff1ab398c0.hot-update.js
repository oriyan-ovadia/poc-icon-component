...
var Primary = {
  render: function render(args) {
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(ThemeProvider, {
...
var layoutCss = css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  gap: 16px;\n  margin-top: 28px;\n"])));
var iconWrapperCss = css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  padding: 12px;\n  row-gap: 16px;\n"])));
var btnCss = css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  height: 80px;\n  width: 80px;\n  background-color: white;\n  box-shadow: 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgba(0, 0, 0, 0.05);\n  border: 1px solid #e2e8f0;\n  border-radius: 0.5rem;\n  cursor: pointer;\n  transition: background-color 0.2s;\n\n  :hover {\n    background-color: #fcfcfc;\n  }\n"])));
...
var AllIcons = {
  render: function render(args) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
      var filteredIcons = iconsArr.filter(function (iconName) {
        return iconName.includes(debouncedSearchQuery);
      });
      setIcons(filteredIcons);
    }, [debouncedSearchQuery]);
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(ThemeProvider, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("form", {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(TextInput, {
          id: "AllIcons_search",
          label: "Search icon",
          onChange: onSearch,
          value: searchQuery
